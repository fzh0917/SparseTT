...
class MultiHeadAttentionTopK(nn.MultiheadAttention):
    def __init__(self, embed_dim, num_heads, top_k, dropout=0., bias=True, add_bias_kv=False, add_zero_attn=False,
...
def multi_head_attention_forward_topk(
    query: Tensor,
    key: Tensor,
    value: Tensor,
